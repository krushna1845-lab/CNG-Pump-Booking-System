    ...
    <div class="wrapper">
        <div class="booking-details">
            ...
            try {
                ...
                PreparedStatement p = con.prepareStatement("UPDATE cng_pump SET cngkg = cngkg + ? WHERE pemail = ?");
                p.setInt(1, cngkg);
                p.setString(2, pemail);
            ...
            <p>Additional CNG (kg): <%= cngkg %></p>
            <p>Pump Email: <%= pemail %></p>
            <a href="View_CNG_Pumps_ctd.jsp" class="btn">Back to View CNG Pumps</a>
            <% } else { %>
            <p>Failed to confirm booking. Please try again.</p>
            <a href="CNG_Pumps_Update.jsp" class="btn">Try Again</a>
            <% }
            } catch (Exception e) {
                out.println(e);
            }
